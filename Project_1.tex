...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Find greatest number of deaths on first day}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in}\NormalTok{ deaths\_df}\SpecialCharTok{$}\NormalTok{X1.}\FloatTok{22.20}\NormalTok{) \{}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{max}\NormalTok{(deaths\_df}\SpecialCharTok{$}\NormalTok{X1.}\FloatTok{22.20}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{first\_city\_deaths }\OtherTok{\textless{}{-}}\NormalTok{ deaths\_df}\SpecialCharTok{$}\NormalTok{Province.State[}\FunctionTok{which.max}\NormalTok{(deaths\_df}\SpecialCharTok{$}\NormalTok{X1.}\FloatTok{22.20}\NormalTok{)]}

\CommentTok{\# Find greatest number of confirmed cases on first day}
\FunctionTok{max}\NormalTok{(confirmed\_df}\SpecialCharTok{$}\NormalTok{X1.}\FloatTok{22.20}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{first\_city\_confirmations }\OtherTok{\textless{}{-}}\NormalTok{ confirmed\_df}\SpecialCharTok{$}\NormalTok{Province.State[}\FunctionTok{which.max}\NormalTok{(confirmed\_df}\SpecialCharTok{$}\NormalTok{X1.}\FloatTok{22.20}\NormalTok{)]}

\CommentTok{\# Find and print origin city}
\ControlFlowTok{if}\NormalTok{ (first\_city\_deaths }\SpecialCharTok{==}\NormalTok{ first\_city\_confirmations) \{}
\NormalTok{  covid\_city\_origin }\OtherTok{\textless{}{-}}\NormalTok{ first\_city\_confirmations}
\NormalTok{\}}
\FunctionTok{print}\NormalTok{(covid\_city\_origin)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# Most recent area to have a confirmed case}
\DocumentationTok{\#\# Use a for loop, if statement, and subsets.}

\NormalTok{recent\_confirmed\_df }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{()}

\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(confirmed\_df)) \{}
  \ControlFlowTok{if}\NormalTok{ (confirmed\_df}\SpecialCharTok{$}\NormalTok{X3.}\FloatTok{9.23}\NormalTok{[i] }\SpecialCharTok{\textgreater{}}\NormalTok{ confirmed\_df}\SpecialCharTok{$}\NormalTok{X3.}\FloatTok{8.23}\NormalTok{[i]) \{}
\NormalTok{    recent\_confirmed\_df }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(recent\_confirmed\_df,confirmed\_df}\SpecialCharTok{$}\NormalTok{Country.Region[i])}
\NormalTok{  \}}
\NormalTok{\}}

\FunctionTok{print}\NormalTok{(recent\_confirmed\_df)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# R Solution}
\CommentTok{\#recent\_confirmed\_df \textless{}{-} paste(confirmed\_df$Province.State[which(confirmed\_df$X3.9.23 \textgreater{} confirmed\_df$X3.8.23)], }
\CommentTok{\#                            confirmed\_df$Country.Region[which(confirmed\_df$X3.9.23 \textgreater{} confirmed\_df$X3.8.23)])}
\CommentTok{\#print(recent\_confirmed\_df)}
\end{Highlighting}
\end{Shaded}
